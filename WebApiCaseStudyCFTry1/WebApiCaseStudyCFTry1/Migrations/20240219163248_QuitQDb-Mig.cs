...
{
    public partial class QuitQDbMig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerGender = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellersSellerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_items_Orders_OrdersOrderId",
                        column: x => x.OrdersOrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK_Order_items_Products_ProductsProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_items_OrdersOrderId",
                table: "Order_items",
                column: "OrdersOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_items_ProductsProductId",
                table: "Order_items",
